...
namespace CrmPlatformAPI.Migrations
{
    ...
    [Migration("20250529150221_atatachment")]
    partial class atatachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrmPlatformAPI.Models.Domain.TicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrmPlatformAPI.Models.Domain.TicketStatusAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TicketStatusHistoryId");

                    b.ToTable("TicketStatusAttachments");
                });
            ...
            modelBuilder.Entity("CrmPlatformAPI.Models.Domain.TicketStatusAttachment", b =>
                {
                    b.HasOne("CrmPlatformAPI.Models.Domain.TicketStatusHistory", "TicketStatusHistory")
                        .WithMany("Attachments")
                        .HasForeignKey("TicketStatusHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
